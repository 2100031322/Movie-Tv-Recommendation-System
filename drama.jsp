...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <img src="/images/drama1.jpg" alt="Horror Movie 1" class="img-fluid">
                <p>Horror Movie Title 1</p>
            </div>
            <div class="col-md-3">
                <img src="/images/darma2.jpg" alt="Horror Movie 2" class="img-fluid">
                <p>Horror Movie Title 2</p>
            </div>
            <div class="col-md-3">
                <img src="/images/drama3.jpg" alt="Horror Movie 3" class="img-fluid">
                <p>Horror Movie Title 3</p>
            </div>
            <div class="col-md-3">
                <img src="/images/drama4.jpg" alt="Horror Movie 4" class="img-fluid">
                <p>Horror Movie Title 4</p>
            </div>
            <div class="col-md-3">
                <img src="/images/drama5.jpg" alt="Horror Movie 5" class="img-fluid">
                <p>Horror Movie Title 5</p>
            </div>
            <div class="col-md-3">
                <img src="/images/drama6.jpg" alt="Horror Movie 6" class="img-fluid">
                <p>Horror Movie Title 6</p>
            </div>
            <div class="col-md-3">
                <img src="/images/drama7.jpg" alt="Horror Movie 6" class="img-fluid">
                <p>Horror Movie Title 6</p>
            </div>
            <div class="col-md-3">
                <img src="/images/drama8.jpg" alt="Horror Movie 6" class="img-fluid">
                <p>Horror Movie Title 6</p>
            </div>
